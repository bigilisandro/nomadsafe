        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <span className="ml-2 text-xl font-bold font-black-ops-one">NomadSafe .</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#what-it-covers" className="text-gray-400 hover:text-white transition-colors">
                  What it covers
                </Link>
              </li>
              <li>
